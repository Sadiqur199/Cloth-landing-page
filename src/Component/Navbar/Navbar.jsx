      ...
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm bg-white dropdown-content mt-5 z-[1] p-2 w-52"
            >
              <Link
                to="/"
                className=" mr-3 font-semibold active text-black hover:border-b-2 hover:border-black"
              >
                <li>Home</li>
              </Link>
              <a
                href="#about"
                className="mr-3 font-semibold text-black hover:border-b-2 hover:border-black"
              >
                <li>AboutUs</li>
              </a>
              <a
